...
import img1 from "../../../assets/images/box-item/card-item-4.jpg";
import img2 from "../../../assets/images/box-item/image-box-10.jpg";
import img3 from "../../../assets/images/box-item/card-item-11.jpg";
          ...
          <div className="row">
            <div className="col-xl-12 col-lg-12">
              <div className="heading-live-auctions">
                <h2 className="tf-title pb-16"> Top selling NFT's</h2>
